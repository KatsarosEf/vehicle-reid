...
def main(string_name, nr_epochs):
    ...
    dataloaders = dataloader(image_datasets, P=12, K=4, val_batch_size=72)
    ...
    scheduler =  optim.lr_scheduler.MultiStepLR(optimizer, milestones=[40, 80, 110, 140, 160, 180, 200, 220, 240, 260, 280], gamma=0.85)
    print("Set.")
...
if __name__ == '__main__':
    ...
    main(string_name = 'coarse_batchall', nr_epochs = 300)
